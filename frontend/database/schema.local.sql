...
CREATE TABLE IF NOT EXISTS student_assessments (
  ...
  feedback TEXT,
  rubric_level_k SMALLINT CHECK (rubric_level_k BETWEEN 1 AND 4),
  rubric_level_s SMALLINT CHECK (rubric_level_s BETWEEN 1 AND 4),
  rubric_level_a SMALLINT CHECK (rubric_level_a BETWEEN 1 AND 4),
  rubric_level_c SMALLINT CHECK (rubric_level_c BETWEEN 1 AND 4),
